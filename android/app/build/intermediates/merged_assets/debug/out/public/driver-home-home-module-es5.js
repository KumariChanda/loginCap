                          ...
                          while (1) {
                            switch (_context.prev = _context.next) {
                              ...
                              case 3:
                                ...
                                if (!(this.filterData[i].etape_location == 4 || this.filterData[i].etape_location == 6)) {
                                  _context.next = 7;
                                  break;
                                }
