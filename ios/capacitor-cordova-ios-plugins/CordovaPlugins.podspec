  ...
  Pod::Spec.new do |s|
    ...
    s.source = { :git => 'https://github.com/ionic-team/does-not-exist.git', :tag => '2.2.1' }
    ...
    s.swift_version  = '5.0'
    s.frameworks = 'Security', 'SystemConfiguration', 'AssetsLibrary', 'MobileCoreServices', 'CoreGraphics'
  end